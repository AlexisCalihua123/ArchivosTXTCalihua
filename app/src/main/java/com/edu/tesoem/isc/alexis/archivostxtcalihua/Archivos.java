...
public class Archivos {
    public final String NomArc = "Datos.txt";
    public ArrayList<String> Datos=new ArrayList<>();
    public boolean  Grabar (Context context,ArrayList<String> Datos ){
try {
    OutputStreamWriter archivo = new OutputStreamWriter( context.openFileOutput(NomArc, Activity.MODE_PRIVATE));
...
return true;
 ...
 public  void Agregar (String dato,ArrayList <String> Datos){
    ...
    public boolean Verifica ( Context context){
      ...
      if(archivo.equals(NomArc)) return true;
      return  false;
